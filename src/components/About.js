...
const About = () => {
  return (
    <><div className="container mt-3 about-background">
      ...
      <h2>Acerca de mi</h2>
      <div className="row align-items-center"> {/* Fila de Bootstrap */}
        {/* Columna para la imagen */}
        <div className="col-7 col-md-2"> {/* En móviles ocupa todo el ancho */}
          <img
            src="/MARIO.png"
            alt="MarioBros"
        ...
        <div className="col-12 col-md-8 prueba">
          <p>
            Hola, soy Juan Sebastián, un desarrollador junior con experiencia en tecnologías como JavaScript, Python, React, Bootstrap, C#, Angular y más.
            Complementariamente, poseo habilidades en diseño, ya que manejo a gran nivel las herramientas de la suite de Adobe, como Photoshop, Illustrator y Premiere Pro, ademas de Figma.
          </p>
        </div>
        <p>
        ...
        <p>
          Mi límite no paró ahí, e impulsado por los videojuegos y el arte digital, me adentré en el mundo del diseño. De igual manera que con los arreglos de celulares y computadoras, empecé a seguir tutoriales de YouTube, pero ahora con programas de la suite de Adobe como Photoshop, Illustrator y Premiere Pro,
